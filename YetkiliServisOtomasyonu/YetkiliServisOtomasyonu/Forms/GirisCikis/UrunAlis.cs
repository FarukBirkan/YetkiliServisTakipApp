    ...
    public partial class UrunAlis : Form
    {
        ...
        void add()
        {
            try
            {
                ...
                dialog = XtraMessageBox.Show("Kasa Çıkışı Yapılsın mı ?","Durum",MessageBoxButtons.OKCancel);
